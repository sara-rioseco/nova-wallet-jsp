...
<div id="root" class="root">
    <div class="deposit-wrapper">
        ...
        <main class="deposit-content-wrapper"><h2>Withdraw funds from your account</h2>
            <div class="deposit-balance-div">
                <div class="balance-wrapper"><h3 class="balance-title">your balance is:</h3>
                    <h2 class="balance-subtitle">USD $600.00</h2></div>
            </div>
            <div class="input-wrapper"><input class="input input-text" type="number" id="deposit-amount"
                                              autocomplete="new-password" placeholder=" " name="amount" required=""
                                              step="0.01" min="0.01" max="10000.01"><label class="label input-label"
                                                                                           for="deposit-amount">Enter
                amount</label></div>
            <button id="button-deposit">Deposit</button>
        </main>
